...
让整个组织共享同一套事实，回答发生过什么、当前什么依赖什么，以及现实变化应该影响哪里。不同模块解释同一事实，不各自制造事实。

- [Purpose](00%20Purpose.md)
- [Principles](00%20Principles.md)
- [Mental Model](00%20Mental%20Model.md)
- [Panorama Topology](00%20Panorama%20Topology.md)
- [Specification](00%20Specification.md)
