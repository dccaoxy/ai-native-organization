...
通过真实执行认识 HAU 与问题空间，并把局部成功转为组织可以重新调用、组装和复现的能力。

- [Purpose](06%20Purpose.md)
- [Principles](06%20Principles.md)
- [Mental Model](06%20Mental%20Model.md)
- [Panorama Topology](06%20Panorama%20Topology.md)
- [Specification](06%20Specification.md)
