...
让一个 HAU 的经历成为组织可以复用、质疑和持续修正的认知，并在需要时带回工作。

- [Purpose](04%20Purpose.md)
- [Principles](04%20Principles.md)
- [Mental Model](04%20Mental%20Model.md)
- [Panorama Topology](04%20Panorama%20Topology.md)
- [Specification](04%20Specification.md)
