...
GitHub 是 **Development Source of Truth**；Obsidian 是 **Project Command Center / Human Dashboard**。新 Human / Work / Codex / Agent 从 [AGENTS.md](AGENTS.md) 开始，再读 [Current State](development/CURRENT_STATE.md)、[Next Actions](development/NEXT_ACTIONS.md) 和当前 [M01 Milestone](development/milestones/M01_MINIMUM_ORGANIZATION.md)。

当前处于 **P0 / Phase 1 收尾与 Phase 2 启动 / M01 — Minimum Organization**。设计基线已冻结，但 M01 尚未实现，E01–E08 尚无真实实验结果。
...
横切体验权威：[X1 Organizational World & UX Shell](X1%20Organizational%20World%20%26%20UX%20Shell/X1%20Organizational%20World%20%26%20UX%20Shell.md)。X1 是 Operating Model 的多视角投影，不改变 00–08 的规则。
...
- [开发 Roadmap](development/ROADMAP.md)
- [当前开发状态](development/CURRENT_STATE.md)
- [下一步](development/NEXT_ACTIONS.md)
- [组织世界观 / World Model](X1%20Organizational%20World%20%26%20UX%20Shell/%E7%BB%84%E7%BB%87%E4%B8%96%E7%95%8C%E8%A7%82%20-%20World%20Model.md)
